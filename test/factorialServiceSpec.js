describe('factorialService.js', function() {
    it('Deve calcular a fatorial dando um numero', function(){
    ...
    it('Deve retornar 1 se o numero calculado for 0', function(){
        expect(factorialService.calculate(0)).toBe(1);
    });

    it('Deve retornar null se um parametro dado for invalido', function(){
